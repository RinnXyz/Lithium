...
Unlike tools such as *KernelSU* or other root-based “Managers,” **LithiumManager** is dedicated to **ADB/Non-Root mode** — while still allowing execution with **Root access** if available. [Learn More](https://fahrez182.github.io/LithiumManager/)
...
- ⚡ **Plugin (Unrooted Module)**  
  Manage third-party modules with unrooted access. [Learn more](https://fahrez182.github.io/LithiumManager/plugin/what-is-plugin.html)  

- 🌐 **WebUI (Unrooted Version)**  
  Execute shell commands with a web-based interactive interface. [Learn More](https://fahrez182.github.io/LithiumManager/plugin/what-is-plugin.html#webui)
...
- [x] [Plugin](https://fahrez182.github.io/LithiumManager/plugin/what-is-plugin.html) system for third-party extensions.  
...
```bash
git clone https://github.com/username/LithiumManager.git
cd LithiumManager
...
LithiumManager does not include or distribute any original Shizuku Manager visual assets or claim to be an official replacement.

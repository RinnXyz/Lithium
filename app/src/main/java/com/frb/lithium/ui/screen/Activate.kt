...
import com.rinn.lithium.ui.util.ClipboardUtil
...
fun WirelessDebuggingCard(
    ...
    val stepByStepUrl =
        "https://fahrez182.github.io/lithium/guide/user-manual.html#start-with-wireless-debugging"
        ...
        Column(
            ...
            LaunchedEffect(adbViewModel.launchDevSettings) {
                if (adbViewModel.launchDevSettings) {
                    ...
                    Log.d("LithiumManager", "launchDevSettings")

...
import com.rinn.lithium.axApp
import com.rinn.lithium.ui.util.HanziToPinyin
import com.rinn.lithium.ui.webui.AppIconUtil
...
class AppsViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun loadInstalledApps() {
        viewModelScope.launch(Dispatchers.IO) {
            ...
            val packages = Lithium.getPackages(0)
...
//    }
    ...
    private fun saveAddedAppsToFile(packageNames: List<String>) {
        ...
        try {
            val fos = Lithium.newFileService()
    ...
    private fun getSavedPackageNames(): List<String> {
        return try {
            val axFile = Lithium.newFileService()

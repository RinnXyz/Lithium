package com.rinn.lithium.ui.webui
...
import com.rinn.lithium.ui.webui.interfaces.AxWebInterface
import com.rinn.lithium.ui.webui.interfaces.KsuWebInterface
import com.rinn.engine.client.Lithium
import com.rinn.engine.core.ConstantEngine
import com.rinn.engine.data.PluginInfo
import com.rinn.engine.utils.AxWebLoader
...
class WebUIActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        plugin = runCatching {
            Lithium.getPluginById(intent.getStringExtra("id")!!)
        }.getOrElse {
        ...
        val axWebLoader = AxWebLoader.Builder()
            ...
            .addDomain("lithium.js").addHandler { view, request ->
                Log.d("WebUIActivity", "request: " + request.url.toString())
                return@addHandler WebResourceResponse(
                    "application/javascript",
                    null,
                    assets.open("js/lithium.js")
                )
            }
            .done()
            .build()
        ...
        val webView = WebView(this).apply {
            ...
            addJavascriptInterface(axWebInterface, "Lithium")

package com.rinn.lithium.ui.screen
...
import com.rinn.lithium.BuildConfig
import com.rinn.lithium.ui.component.AxSnackBarHost
import com.rinn.lithium.ui.component.ConfirmResult
import com.rinn.lithium.ui.component.KeyEventBlocker
import com.rinn.lithium.ui.component.rememberConfirmDialog
import com.rinn.lithium.ui.component.rememberLoadingDialog
import com.rinn.lithium.ui.theme.GREEN
import com.rinn.lithium.ui.theme.ORANGE
import com.rinn.lithium.ui.theme.RED
import com.rinn.lithium.ui.util.LocalSnackbarHost
import com.rinn.lithium.ui.viewmodel.ViewModelGlobal
import com.rinn.engine.client.Axeron
import com.rinn.engine.client.PluginService
import com.rinn.engine.client.PluginService.flashPlugin
import com.rinn.engine.core.ConstantEngine
import com.rinn.engine.core.Engine.Companion.application
import com.rinn.engine.utils.PathHelper
            ...
            TopBar(
                ...
                onSave = {
                    scope.launch {
                        ...
                        val file = File(baseDir, "lithium_install_log_${date}.log")
...
fun uninstallPermanently(
    ...
    val cmd = ". functions.sh; uninstall_lithium \"${prefs.getBoolean("enable_developer_options", false)}\" \"${BuildConfig.APPLICATION_ID}\"; exit 0"

...
1. Start in LithiumManager
2. [Enable "**Wireless Debugging**"](#enable-wireless-debugging)
3. Tap "**Pair device with pairing code**" in "**Wireless Debugging**"
4. Enter pairing code in LithiumManager's notification until "**Pairing successfully**"
5. Back to LithiumManager and wait until connected (On some devices you need to click "**Start**" again)
...
#### Start LithiumManager

Copy the command and paste into the terminal. If there is no problem, you will see that LithiumManager has started successfully in LithiumManager app.

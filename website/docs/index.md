...
hero:
  name: "Lithium Manager"
  tagline: Lithium Manager is an Android application designed to provide deeper control over apps and the system.
  actions:
    - theme: brand
      text: Get Started
    ...
    - theme: alt
      text: View on GitHub
      link: https://github.com/RinnXyz/LithiumManager
    - theme: alt
      text: Download
